      ...
      <Content style={{ padding: '2rem', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
        {selectedTab === 'home' && (
          <div style={{ marginBottom: '2rem', textAlign: 'center' }}>
            ...
            <p>Welcome to Data View, your one-stop solution for data management. Whether you're a business owner, researcher, or data enthusiast, Data View provides the tools you need to organize, analyze, and visualize your data.</p>
          </div>
        )}
        {selectedTab === 'about' && (
          <div style={{ marginBottom: '2rem', textAlign: 'center' }}>
            <h2>About Data View</h2>
            <p>Data View is a data management application where users can register, create databases, and upload CSV and XLSX files. They can then view and manage their data through intuitive interfaces.</p>
          </div>
        )}
        {selectedTab === 'login' && (
    ...
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Content style={{ padding: '2rem', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
        {selectedTab === 'home' && (
          <div style={{ marginBottom: '2rem', textAlign: 'center' }}>
            <h2>Welcome to Data View</h2>
            <p id ="home_1">Welcome to Data View, your one-stop solution for data management. Whether you're a business owner, researcher, or data enthusiast, Data View provides the tools you need to organize, analyze, and visualize your data.</p>
            <div className="data-visualization"></div> {*//* Add this line *//*}
          </div>
        )}
        {selectedTab === 'about' && (
          <div style={{ marginBottom: '2rem', textAlign: 'center' }}>
